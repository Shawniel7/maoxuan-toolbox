...
# 笔者的话
当代的中国年轻人面临很多生活上的困惑——工作里的选择、关系里的僵局、学习里的内耗。我始终认为,毛泽东思想里真正具有普适价值的,是一套分析问题的方法工具.
起因是一次跟我爸的闲聊,我和他提到现在AI发展迅速,张雪峰AI可以模仿语气来做专业选择. 因此他问我能不能做一个毛主席的版本,用毛泽东思想解答一些疑惑.
毛泽东思想是马克思列宁主义在中国的运用和发展，是被实践证明了的关于中国革命的正确的理论原则和经验总结，是中国共产党集体智慧的结晶。
《毛泽东选集》是1951年人民出版社出版的图书，作者是毛泽东。该书是毛泽东思想的重要载体，是毛泽东思想的集中展现，亦是对20世纪的中国影响最大的书籍之一。毛泽东思想从新民主主义革命、社会主义革命和社会主义建设、革命军队的建设和军事战略、政策和策略等六个方面，以独创性的理论丰富和发展了马克思列宁主义.
但是,对于21世纪的青年,面临人生的迷茫,寻找工作或者升学的焦虑,恋爱的问题,家庭关系,社会的代际矛盾,后疫情下的经济问题,毛泽东思想能否引领2026年的年轻人的方向.
我认为答案是可行的,因此制作了这个项目.
这个项目试图把这些工具从历史语境中抽出来,用来帮助当代年轻人思考生活、工作、学习中的困惑。
这是一个基于《毛泽东选集》四卷全集的 RAG 问答系统,不是政治宣传或人生鸡汤;它所做的事,是用毛泽东本人在 1930-1940 年代处理复杂局面时用过的那套思维方法(主要矛盾、矛盾的特殊性、实践与认识、持久战、调查研究……),帮你把眼前的问题拆成你自己能继续分析下去的结构。
...
对没读过原著的人稍微说一下。《毛泽东选集》四卷本,收录 1925 到 1949 年间毛写的 158 篇文章,**不是"领袖讲话集"**,而是在真实革命和战争里产生的分析、判断、决策记录——战略推演(《论持久战》)、方法论反思(《矛盾论》《实践论》)、组织问题处理(《党委会的工作方法》)、怎么做调查研究(《反对本本主义》)。写作语境是激烈的政治斗争,但内核是一个更普适的问题:**信息不全、资源有限、风险很大的情况下,怎么做出靠谱的判断**。

毛选同时是一份政治文本和一份方法论文本。**这两层可以分开看**。本项目只用它的方法论层面——怎么分析矛盾、怎么从实践里修正认识、怎么判断主次、怎么面对不确定性。历史评价、政治立场、具体历史事件的对错——这些留给历史学家和读者本人,本项目不替任何人做判断。我知道这种切分是有争议的:有人觉得方法和内容不可分,有人觉得任何使用毛选的行为本身就是一种立场。两种意见我都尊重,这里只是选了另一条路——用它擅长的部分,承认它局限的部分。

1930-40 年代的中国和今天当然不是一回事。但某些问题的**结构**是相似的:怎么在一堆矛盾里识别主要那个、怎么避免用教条代替实地调查、怎么在长期不利的局面里保持判断力不崩。这些问题在当代个人决策(换工作、做项目、处理关系、选方向)里仍然反复出现。你不一定要同意毛选的结论,但可以研究它**处理问题的方式**。

最后一点诚实的承认:毛选不是万能的分析工具。它在战略判断、组织管理、信息不对称的复杂局面里很强;在处理情感创伤、亲密关系修复、存在主义焦虑这类问题上几乎完全失效——本来就不是为它们设计的。本项目的 agent 被专门提示过这一点,遇到够不着的问题会诚实说"帮不上忙",不硬套方法论。
...
- **碰到分析方法论够不着的问题,会礼貌拒绝。**
  输入"我最爱的Vtuber上周毕业了,我没能给她上一个舰长,现在非常自责",系统不会套用毛选强行分析——它会简短共情、说明"这不是这个工具能帮上忙的地方"、建议找信任的人倾诉或专业心理咨询师。这是产品设计的一部分,不是 bug。同理拒绝:失恋、抑郁、急性心理危机、具体医疗/法律/投资建议、政治表态。
...
2. **角色边界不清**。把一个历史人物的语言风格商品化,越过了合理使用的舒适区。Agent 始终以"熟读毛选的现代分析师"身份说话,不扮演毛泽东本人,不用第一人称。相比于单纯的听毛主席的教导,不如学习毛主席的思想,使用他教给我们的东西,去解决新的问题.
...
- **中国大陆网络**:`setup.sh` 会访问 `marxists.org`(下载毛选全集)和 `huggingface.co`(下载 embedding 模型);运行时需要访问 `api.anthropic.com`(Claude 推理)。三者都可能需要稳定的国际连接。Hugging Face 可以通过镜像加速(搜索 `hf-mirror`),其他两个目前没有国内镜像。此外,有测试反馈遇到了毛选原文链接打不开的问题,此问题等待后续优化升级.
...
- **政治立场输出工具**。agent 被明确禁止就具体政治人物、政策、事件发表评价。项目只处理方法论层面。
- *心理/法律/医疗咨询替代品**。遇到这些需求会礼貌拒绝并建议寻求专业帮助。
- **fine-tuned 的"毛泽东 AI"**。没有角色扮演,不用第一人称,不模仿毛的语气。引用毛选原文时始终加书名号 + 出处链接,让文本和 AI 自己的话清晰可辨。
- **应试 / 考研 / 政治考试辅导工具**。不提供标准答案,不适合应试场景。
